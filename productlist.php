                        ...
                        <table class="table table-striped table-bordered dom-jQuery-events">
                            ...
                            <tbody>
                                ...
                                if(isset($_GET['seller_id'])) {
                                    $jj = $con->query("select product.* , seller.sname from product left join seller on product.seller_id = seller.id WHERE product.seller_id='".$_GET['seller_id']."' order by product.id desc");
                                }
                                else
                                {
                                    $jj = $con->query("select product.* , seller.sname from product left join seller on product.seller_id = seller.id order by id desc");
                                }
